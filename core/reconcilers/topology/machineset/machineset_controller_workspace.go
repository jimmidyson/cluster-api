...
// MachineSet{}s through the wrong endpoint on every Cluster event.
//
...
func (r *Reconciler) SetupWithMulticlusterManager(
	...
	clusterToMachineSets, err := util.ClusterToTypedObjectsMapper(r.Client, &clusterv1.MachineSetList{}, scheme)
	if err != nil {
		return err
	}
